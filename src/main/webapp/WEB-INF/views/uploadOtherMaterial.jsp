...
.center{
  ...
  padding: 15px;
		...
		<h2>Upload Material
		  ...
		  <a class="btn btn-outline-primary" href="umaterialPDF">PDF</a>
		</div>
	  </h2>

<div class="card border-primary mb-3 center" style="max-width: 50rem;">
	<div class="card-header" style="text-align:center; font-size: 20px;">PDF</div>
...
<form action = "addBook" method="post" >
 <fieldset>
    ...
    <div class="form-group">
      <input type="hidden" class="form-control" name="type" id="type" value="PDF">
    </div><br>
